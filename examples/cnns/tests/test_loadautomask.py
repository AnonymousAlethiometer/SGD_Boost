...
train_loader, test_loader = get_cifar_dataloaders(train_batch_size=1, test_batch_size=64, dataset='cifar10', num_workers=4, datadir='/media/data/Unknow/cifar10', skip_download_check=True)
patch_num = 8
