...
"""
comes from
https://github.com/idstcv/ZenNAS/blob/main/ZenNet/__init__.py
"""
...
# Unknow: zennet_size05M, zennet_size1M, zennet_size2M modified for convenience
def zennet_size05M(num_classes, pretrained=False):
    model_name = 'zennet_cifar10_model_size05M_res32' if num_classes == 10 else 'zennet_cifar100_model_size05M_res32'
    return get_ZenNet(model_name, pretrained=pretrained)

def zennet_size1M(num_classes, pretrained=False):
    model_name = 'zennet_cifar10_model_size1M_res32' if num_classes == 10 else 'zennet_cifar100_model_size1M_res32'
    return get_ZenNet(model_name, pretrained=pretrained)

def zennet_size2M(num_classes, pretrained=False):
    model_name = 'zennet_cifar10_model_size2M_res32' if num_classes == 10 else 'zennet_cifar100_model_size2M_res32'
    return get_ZenNet(model_name, pretrained=pretrained)
